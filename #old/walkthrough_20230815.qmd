...
# transformation
data_H$bid = data_H$block
data_H$cid = data_H$childID
data_H$uid = data_H$sentence
data_H$wid = data_H$word

data_H$HS = data_H$hearing_status
data_H$A = data_H$chronological_age
data_H$Am = data_H$A - min(data_H$A)

data_H = data_H[, c('bid','cid','uid','wid','HS','A','Am','Hwsib')]
# str(data_H)
